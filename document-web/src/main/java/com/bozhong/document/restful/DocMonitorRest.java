...
public class DocMonitorRest {
    ...
    public String simulateAsyncRequest(@Context Request request, @Context UriInfo uriInfo, @Context HttpHeaders httpHeaders) {
        ...
        simulateRequest(requestUrl, appId, docFileUrl, callNumber);
    ...
    public String simulateBatchAsyncRequest(@Context Request request, @Context UriInfo uriInfo, @Context HttpHeaders httpHeaders) {
        ...
        System.out.println(requestUrl);
        simulateBatchRequest(requestUrl, appId, docFileUrlList);
        return ResultMessageBuilder.build().toJSONString();
    }
     ...
     */
    private void simulateBatchRequest(final String requestUrl, String appId, String docFileUrlList) {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                httpMethod.setRequestBody(new NameValuePair[]{appIdParam, docFileUrlParam});
...
//                            getBytes("ISO8859-1")));
     ...
     * @param callNumber
     */
    private void simulateRequest(final String requestUrl, String appId, String docFileUrl, String callNumber) {
